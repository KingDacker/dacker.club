        ...
        <section class="m-b-lg">
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    <input type="email" name="email" placeholder="输入你注册账号的邮箱" value="" class="form-control input-lg text-center no-border">
                </div>
                <div class="form-group">
                    <input type="password" name="password" placeholder="密码(6-20位)" value="" class="form-control input-lg text-center no-border">
                </div>
                <div class="form-group">
                    <input type="password" name="password_com" placeholder="密码(6-20位)" value="" class="form-control input-lg text-center no-border">
                </div>
                <button type="submit" class="btn btn-lg btn-warning lt b-white b-2x btn-block btn-rounded">
                    <i class="icon-arrow-right pull-right"></i><span class="m-r-n-lg">提交</span>
                </button>
