                    ...
                    <div class="col-sm-10">
                        ...
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <strong>投稿基本信息</strong>
                            </header>
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">标题(必填)</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="title" data-required="true" class="form-control" placeholder="5-15个字符">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">价格(选填)</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">投稿类型(必填)</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">内容(选填)</label>
                                    <div class="col-sm-9">
...
<script>
    ...
    var img_arr = [];
    initFileInput('upload_image','/test/test');
